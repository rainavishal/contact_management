...
const Contacts = () => {
    ...
    return (
        ...
        <div className="justify-center pt-28 text-slate-50 bg-gray-100  p-4 h-full w-full ">
...
{AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="text-2xl">No Contact Found Please add contact from <br /> Create Contact Button</h1>
                </div>}

                <div className="m-4">
                    <button className="rounded bg-sky-950 p-3 pr-4 pl-4 text-xl">
