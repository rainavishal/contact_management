...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 bg-gray-100 pb-8" >
      <h1 className="text-4xl font-bold mb-4 mt-6 text-pink-600">Corona Cases Chart</h1>
      ...
      <h1 className="text-4xl font-bold mb-4 mt-6 text-blue-500">Corona Cases World Map</h1>
      <div
